...
rootfs-include-flatpaks FLATPAKS_FILE="src/flatpaks":
    #!/usr/bin/env bash
    {{ _ci_grouping }}
...
@build image=default_image livesys="1" flatpaks_file="src/flatpaks" compression="squashfs" extra_kargs="NONE" container_image=image polkit="1": \
    checkroot \
